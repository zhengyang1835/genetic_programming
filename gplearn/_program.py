...
class _Program(object):
    ...
    def raw_fitness(self, X, y, sample_weight):
        ...
        if hasattr(self.metric.function, "__code__") and self.metric.function.__code__.co_argcount == 4:
            return self.metric.function(y, y_pred, sample_weight, self)
        else:
            return self.metric.function(y, y_pred, sample_weight)
